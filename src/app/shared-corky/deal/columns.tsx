...
export const getColumns = ({
  ...
  */
...

  {
    ...
    render: (_: string, row: any) => (
      ...
      <Link
        href={routes.marketplace.dealDetails(row.id) }
        className=' hover:font-bold hover:underline'
      >
  ...
  */
  ...
  /* 거래유형 (직거래, 택배거래) */
  {
    title: <HeaderCell title="거래유형" />,
    dataIndex: 'dealType',
    key: 'dealType',
    width: 100,
    render: (value: string) => (
      <Text className="text-center">직거래</Text>
    ),
  },
  ...
  /* 상태 (거래온료, 거래중) */
  {
    ...
    width: 100,
    render: (value: string) => (
      <Text className="text-center">거래중</Text>
    ),
  },

  {
    title: <HeaderCell title="신고" />,
      ...
      <div className="flex items-center justify-end gap-3 pe-4">
        ...
        */}
        ...
        <Tooltip
          ...
          color="invert"
        >
          <Link href={routes.marketplace.dealDetails(row.id)}>
            <ActionIcon
              tag="span"
              size="sm"
              variant="outline"
