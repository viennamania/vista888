...

  {
    ...
    render: (value: string) => (
      <Text className='text-center'>
        { value === '1' ? '상품' : value === '2' ? '레피소식' : value === '3' ? '링크' : '기타' }
      </Text>
    ),
  },
  ...
  /*
  {
    ...
    render: (_: any, row: any) => (
      <div className="flex items-center justify-start ml-5">
        <TableAvatar
          src={row.userAvatar || '/static/img/default_avatar.png'}
          name={row.userName || '등록자'}
          ///description={row.userEmail || '등록자'}
          description={row.userNickname || '등록자'}
        />
      </div>
    ),
  },
    ...
    render: (_: string, row: any) => (
      <div className="flex items-center justify-end gap-3 pe-4">
        ...
        <Tooltip
          ...
          color="invert"
        >
          <Link href={routes.promotion.bannerEdit(row.id)}>
            <ActionIcon
              tag="span"
              size="sm"
              variant="outline"
        ...
        <Tooltip
          ...
          color="invert"
        >
          <Link href={routes.promotion.bannerDetails(row.id)}>
            <ActionIcon
              tag="span"
              size="sm"
              variant="outline"
