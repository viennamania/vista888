    ...
    render: (_: string, row: any) => (
      <div className="flex flex-col gap-2 items-center justify-center  ">
        ...
        <Link href={routes.order.details(row.id)}>
          <Text className="text-center hover:font-bold hover:underline">{row.id}</Text>
        </Link>
  ...
  /*
  {
    ...
    render: (_: string, row: any) => (
      <div className="flex flex-col gap-2 items-center justify-center">
        ...
        <Tooltip
          size="sm"
          content={() => {return '회원번호: ' + row?.order?.id}}
          placement="top"
          color="invert"
        >
          ...
          <button
            ...
            onClick={() => onClickUser(row?.order?.id)}
          >  
          
            <Text className="text-center">{row?.order?.userName}</Text>
          </button>
  ...
  /*상품 */
  {
    ...
    render: (_: string, row: any) => (
      <div className="flex flex-col gap-2 items-center justify-center ">
        ...
        <Tooltip
          size="sm"
          content={() => {return '상품번호: ' + row?.product?.id}}
          placement="top"
          color="invert"
        >
          <>
  ...
  /* 주문수량 */
  {
    ...
    render: (_: string, row: any) => (
      <div className="flex flex-col gap-2 ">
        ...
        {row?.product?.options?.map((option: any, index: number) => (
          
          <Text className="text-center" key={index}>
            {option?.name}
          </Text>
        ))}
