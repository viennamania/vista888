...
export const getColumns = ({
...

  {
    ...
    render: (_: string, row: any) => (
      ...
      <Text className="text-center">카테고리이름</Text>
...

  {
    ...
    render: (_: string, row: any) => (
      ...
      <Link
        href={ routes.channel.details(row.id) }
      ...
      <div className="flex items-center justify-end gap-3 pe-4">
        ...
        */}
        ...
        <Tooltip
          ...
          color="invert"
        >
          <Link href={routes.channel.details(row.id)}>
            <ActionIcon
              tag="span"
              size="sm"
              variant="outline"
