...

  {
    ...
    render: (value: string, row: any) => (
      ...
      <div className='flex flex-row items-center justify-start gap-5'>
        ...
        {(row.id === '1') && (
          <PiNumberCircleOne className="h-4 w-4" />
        )}

        {(row.id === '2') && (
          <PiNumberCircleTwo className="h-4 w-4" />
        )}

        {(row.id === '3') && (
          <PiNumberCircleThree className="h-4 w-4" />
        )}
        ...
        {(row.id === '5') && (
          <PiNumberCircleFive className="h-4 w-4" />
        )}

        {(row.id === '6') && (
          <PiNumberCircleSix className="h-4 w-4" />
        )}

        {(row.id === '7') && (
          <PiNumberCircleSeven className="h-4 w-4" />
        )}
